...
class AdminTaxUpdate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            //fixed LepeNU
            $_POST['value'] = Database::clean_string($_POST['value']);
            $_POST['value_type'] = Database::clean_string($_POST['value_type']);
            $_POST['type'] = Database::clean_string($_POST['type']);
            $_POST['billing_type'] = Database::clean_string($_POST['billing_type']);
