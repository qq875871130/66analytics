...
<div class="animate__animated animate__fadeIn">
    <div class="d-flex justify-content-between mb-2">
        <div>
            <small class="text-muted font-weight-bold text-uppercase"><?= language()->dashboard->referrers->referrer_host ?></small>
        </div>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        ...
                        <?php else: ?>
                            <span title="<?= language()->dashboard->referrers->null ?>" class="align-middle"><?= language()->dashboard->referrers->null ?></span>
                        <?php endif ?>
                    </div>
