...
<div class="animate__animated animate__fadeIn">
    <div class="d-flex justify-content-between mb-2">
        <div>
            <small class="text-muted font-weight-bold text-uppercase"><?= language()->dashboard->referrer_paths->referrer_path ?></small>
        </div>
    ...
    <?php else: ?>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        ...
                        <?php endif ?>
                        <span title="<?= $row->referrer_path ?? language()->dashboard->referrer_paths->null ?>" class="align-middle"><?= $row->referrer_path ?? language()->dashboard->referrer_paths->null ?></span>
        ...
        <?php if($data->total_rows > count($data->rows)): ?>
            <a href="<?= url('dashboard/referrers') ?>"><?= sprintf(language()->global->view_x_more, nr($data->total_rows - count($data->rows))) ?></a>
        <?php endif ?>
