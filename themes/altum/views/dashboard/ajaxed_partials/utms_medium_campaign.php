    ...
    <div class="d-flex justify-content-between mb-2">
        <div>
            <small class="text-muted font-weight-bold text-uppercase">
                <?= language()->dashboard->utms->utm_medium ?> / <?= language()->dashboard->utms->utm_campaign ?>
            </small>
        </div>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        <span><?= $row->utm_medium ?? language()->dashboard->utms->null ?> / <?= $row->utm_campaign ?? language()->dashboard->utms->null ?></span>
                    </div>
