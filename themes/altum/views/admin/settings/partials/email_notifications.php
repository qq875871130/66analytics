...
<div>
    ...
    <div class="custom-control custom-switch my-3">
        ...
        <label class="custom-control-label" for="contact"><?= language()->admin_settings->email_notifications->contact ?></label>
        <small class="form-text text-muted"><?= language()->admin_settings->email_notifications->contact_help ?></small>
    </div>
