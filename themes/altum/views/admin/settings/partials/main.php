...
<div>
    ...
    <div class="form-group">
        <label for="not_found_url"><i class="fa fa-fw fa-sm fa-compass text-muted mr-1"></i> <?= language()->admin_settings->main->not_found_url ?></label>
        <input id="not_found_url" type="url" name="not_found_url" class="form-control form-control-lg" value="<?= settings()->main->not_found_url ?>" />
        <small class="form-text text-muted"><?= language()->admin_settings->main->not_found_url_help ?></small>
    </div>
    ...
    <div class="form-group">
        <label for="default_results_per_page"><i class="fa fa-fw fa-sm fa-list-ol text-muted mr-1"></i> <?= language()->admin_settings->main->default_results_per_page ?></label>
    ...
    <div class="form-group">
        <label for="default_order_type"><i class="fa fa-fw fa-sm fa-sort text-muted mr-1"></i> <?= language()->admin_settings->main->default_order_type ?></label>
        <select id="default_order_type" name="default_order_type" class="form-control form-control-lg">
            <option value="ASC" <?= settings()->main->default_order_type == 'ASC' ? 'selected="selected"' : null ?>><?= language()->global->filters->order_type_asc ?></option>
            <option value="DESC" <?= settings()->main->default_order_type == 'DESC' ? 'selected="selected"' : null ?>><?= language()->global->filters->order_type_desc ?></option>
        </select>
    </div>
</div>
