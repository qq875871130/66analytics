...
<div>
    ...
    <div class="form-group">
        <label for="brand_name"><?= language()->admin_settings->business->brand_name ?></label>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="form-group">
                ...
                <input id="tax_type" type="text" name="tax_type" class="form-control form-control-lg" value="<?= settings()->business->tax_type ?>" placeholder="<?= language()->admin_settings->business->tax_type_placeholder ?>" />
            </div>
        </div>
