...
<div>
    <ul class="nav nav-pills d-flex flex-fill flex-column flex-lg-row mb-3" role="tablist">
        <li class="nav-item flex-fill text-center" role="presentation">
            <a class="nav-link active" id="pills-guests-tab" data-toggle="pill" href="#pills-guests" role="tab" aria-controls="pills-home" aria-selected="true"><?= language()->admin_settings->announcements->guests ?></a>
        </li>
        <li class="nav-item flex-fill text-center" role="presentation">
            <a class="nav-link" id="pills-users-tab" data-toggle="pill" href="#pills-users" role="tab" aria-controls="pills-users" aria-selected="false"><?= language()->admin_settings->announcements->users ?></a>
        </li>
    </ul>
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-guests" role="tabpanel" aria-labelledby="pills-guests-tab">
            <div class="form-group">
                <label for="guests_content"><?= language()->admin_settings->announcements->content ?></label>
            ...
            <div class="form-group">
                <label for="guests_text_color"><?= language()->admin_settings->announcements->text_color ?></label>
            ...
            <div class="form-group">
                <label for="guests_background_color"><?= language()->admin_settings->announcements->background_color ?></label>
        ...
        <div class="tab-pane fade" id="pills-users" role="tabpanel" aria-labelledby="pills-users-tab">
            <div class="form-group">
                <label for="users_content"><?= language()->admin_settings->announcements->content ?></label>
            ...
            <div class="form-group">
                <label for="users_text_color"><?= language()->admin_settings->announcements->text_color ?></label>
            ...
            <div class="form-group">
                <label for="users_background_color"><?= language()->admin_settings->announcements->background_color ?></label>
