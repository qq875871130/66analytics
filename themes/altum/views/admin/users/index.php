            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_plan_id" class="small"><?= language()->admin_users->main->plan_id ?></label>
                        ...
                        <div class="form-group px-4">
                            <label for="filters_country" class="small"><?= language()->admin_users->main->country ?></label>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                <option value="datetime" <?= $data->filters->order_by == 'datetime' ? 'selected="selected"' : null ?>><?= language()->admin_users->main->datetime ?></option>
                                <option value="last_activity" <?= $data->filters->order_by == 'last_activity' ? 'selected="selected"' : null ?>><?= language()->admin_users->main->last_activity ?></option>
                                ...
                                <option value="total_logins" <?= $data->filters->order_by == 'total_logins' ? 'selected="selected"' : null ?>><?= language()->admin_users->main->total_logins ?></option>
                            </select>
                        </div>
