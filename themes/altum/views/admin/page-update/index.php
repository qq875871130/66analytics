        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group" data-type="internal">
                ...
                <select id="editor" name="editor" class="form-control form-control-lg">
                    <option value="wysiwyg" <?= $data->page->editor == 'wysiwyg' ? 'selected="selected"' : null ?>><?= language()->admin_pages->input->editor_wysiwyg ?></option>
                    <option value="raw" <?= $data->page->editor == 'raw' ? 'selected="selected"' : null ?>><?= language()->admin_pages->input->editor_raw ?></option>
                </select>
            </div>
...
<script>
    ...
    let editor_handler = (event = null) => {
        if(event && !confirm(<?= json_encode(language()->admin_pages->input->editor_confirm) ?>)) {
