    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?= language()->team_create_modal->header ?></h5>
            ...
            <div class="modal-body">
                <form name="team_create" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= language()->team_create_modal->input->name ?></label>
                        <input type="text" class="form-control form-control-lg" name="name" required="required" />
                    </div>

                    <div class="form-group">
                        <label><?= language()->team_create_modal->input->websites_ids ?></label>
                        ...
                        <small class="form-text text-muted"><?= language()->team_create_modal->input->websites_ids_help ?></small>
                    </div>
